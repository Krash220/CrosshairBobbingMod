    ...
    private static class ConfigScreen extends Screen {
        ...
        protected void init() {
            ...
            for (String key : DEFAULT.keySet()) {
                this.addDrawableChild(new ButtonWidget(this.width / 2 - 150, i, 300, 20, getValueText(key), btn -> {
                    set(key, !check(key));
            ...
            this.addDrawableChild(new ButtonWidget(this.width / 2 - 100, this.height - 27, 200, 20, ScreenTexts.DONE, btn -> this.onClose()));
        }
