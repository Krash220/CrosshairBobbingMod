...
public class Render {
    ...
    public static boolean isDebugCrosshair() {
        ...
        return mc.options.hudHidden || mc.options.getPerspective() != Perspective.FIRST_PERSON || mc.options.debugEnabled && !mc.player.hasReducedDebugInfo() && !mc.options.getReducedDebugInfo().getValue();
    }
